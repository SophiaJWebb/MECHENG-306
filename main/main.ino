...
#define CALIBRATION // Comment out to move away from edges
...
void loop() {
    ...
    switch (STATE) {
      ...
      case HOMING: {
        ...
        while (!left_hit){
          Serial.print("left_hit is:");
          Serial.println(left_hit);
        }
        left_hit = false;
        digitalWrite(M1, CCW);
        digitalWrite(M2, CCW);
